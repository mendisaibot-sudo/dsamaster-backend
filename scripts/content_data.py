...
PYTHON_BASICS_OUTLINE = [
    ("Variables and Types", "variables-and-types", "beginner", 15, [
        ...
        ("coding", "Write a line that converts '100' to an integer and stores it in variable n.", "n = int('100')"),
    ]),
    ...
    ("Control Flow - if/else/elif", "control-flow-if-else", "beginner", 20, [
        ...
        ("coding", "Write an if statement that checks if x is even and prints 'even', else 'odd'.", "if x % 2 == 0:\n    print('even')\nelse:\n    print('odd')"),
    ]),
    ...
    ("while Loops", "while-loops", "beginner", 15, [
        ...
        ("coding", "Write a while loop that prints numbers 1 to 5.", "i = 1\nwhile i <= 5:\n    print(i)\n    i += 1"),
    ]),
    ("Functions", "functions", "beginner", 20, [
        ...
        ("coding", "Define a function add(a, b) that returns their sum.", "def add(a, b):\n    return a + b"),
    ]),
    ...
    ("Lists", "lists", "beginner", 20, [
        ...
        ("coding", "Create a list evens containing even numbers from 0 to 10.", "evens = [0, 2, 4, 6, 8, 10]"),
    ]),
    ("Dictionaries", "dictionaries", "beginner", 20, [
        ...
        ("mcq", "How do you safely get a value from a dict without KeyError?", ["d.key", "d.get(key)", "d.fetch(key)", "d[key]?"], "1"),
    ]),
    ("Tuples", "t
